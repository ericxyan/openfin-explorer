            ...
            describe(`Page # ${i} -- section ${j}`, () => {
                ...
                if (sectionContent.hasOwnProperty('subSections') && sectionContent.subSections.length > 0) {
                    ...
                    it('should format sub-section content types differently', () => {
                        const typeCount = { code: 0, text: 0, codeWithInput: 0, codeWithDomUpdate: 0, codeWithInputUpdateDom: 0};
                        ...
                        assert.equal(section.find('.codeWithDomUpdate').length, typeCount.codeWithDomUpdate);
                        assert.equal(section.find('.codeWithInputUpdateDom').length, typeCount.codeWithInputUpdateDom);
                    });
                } else {
